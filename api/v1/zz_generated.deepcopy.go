...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HibernationRule) DeepCopyInto(out *HibernationRule) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HibernationRule.
func (in *HibernationRule) DeepCopy() *HibernationRule {
	if in == nil {
		return nil
	}
	out := new(HibernationRule)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *HibernationRule) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HibernationRuleList) DeepCopyInto(out *HibernationRuleList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]HibernationRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HibernationRuleList.
func (in *HibernationRuleList) DeepCopy() *HibernationRuleList {
	if in == nil {
		return nil
	}
	out := new(HibernationRuleList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *HibernationRuleList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HibernationRuleSpec) DeepCopyInto(out *HibernationRuleSpec) {
	*out = *in
	if in.Matchers != nil {
		in, out := &in.Matchers, &out.Matchers
		*out = make([]Matchers, len(*in))
	...
	if in.Schedules != nil {
		in, out := &in.Schedules, &out.Schedules
		*out = make([]ReentrantSchedule, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HibernationRuleSpec.
func (in *HibernationRuleSpec) DeepCopy() *HibernationRuleSpec {
	if in == nil {
		return nil
	}
	out := new(HibernationRuleSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HibernationRuleStatus) DeepCopyInto(out *HibernationRuleStatus) {
	*out = *in
	in.LastModified.DeepCopyInto(&out.LastModified)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HibernationRuleStatus.
func (in *HibernationRuleStatus) DeepCopy() *HibernationRuleStatus {
	if in == nil {
		return nil
	}
	out := new(HibernationRuleStatus)
	in.DeepCopyInto(out)
	return out
}
